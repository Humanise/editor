        ...
        <fields>
          <field label="Udbyder">
            <dropdown key="provider">
              <option text="Google - statisk" value="google-static"/>
              <option text="Google - interaktivt" value="google-interactive"/>
            </dropdown>
          </field>
          <field label="Type">
            <dropdown key="maptype">
              <option text="Veje" value="roadmap"/>
              <option text="Terræn" value="terrain"/>
              <option text="Satellit" value="satellite"/>
              <option text="Hybrid" value="hybrid"/>
            </dropdown>
          </field>
          <field label="Zoom">
