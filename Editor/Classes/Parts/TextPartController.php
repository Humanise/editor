...
class TextPartController extends PartController
{
          ...
          <left>
            <overflow height="400">
              <selection value="all" name="imageChooserSelection">
                ...
                <option text="Ikke brugt" icon="monochrome/round_question" value="unused"/>
                <title>Grupper</title>
                <option text="Uden gruppe" icon="common/folder_grey" value="nogroup"/>
  ...
  function getToolbars() {
    return [
      ...
      <item label="{Justify; da:Justering}">
    ...
    UI::translate(['Image', 'da' => 'Billede']) =>
      ...
      <divider/>
      <item label="{Placement; da:Placering}">
