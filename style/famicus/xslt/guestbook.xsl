...
<tr>
<th align="left"><xsl:value-of select="//i8n:text[@key='list-header-time']"/></th>
<th align="left"><xsl:value-of select="//i8n:text[@key='list-header-name']"/></th>
<th  align="left"><xsl:value-of select="//i8n:text[@key='list-header-text']"/></th>
</tr>
<xsl:apply-templates/>
</table>
</xsl:template>
...
<tr>
<td valign="top" class="time"><xsl:value-of select="gb:time/@day"/>-<xsl:value-of select="gb:time/@month"/>-<xsl:value-of select="gb:time/@year"/><xsl:text> </xsl:text><xsl:value-of select="gb:time/@hour"/>:<xsl:value-of select="gb:time/@minute"/>:<xsl:value-of select="gb:time/@second"/></td>
<td valign="top" class="name"><xsl:value-of select="gb:name"/></td>
<td valign="top" class="text"><xsl:apply-templates select="gb:text"/></td>
</tr>
...
<tr>
<th><xsl:value-of select="//i8n:text[@key='newitem-label-text']"/></th><td width="100%"><textarea  style="width:100%" type="text" name="text" rows="10"><xsl:comment/></textarea></td>
</tr>
