      ...
      <div class="layout_middle">
        ...
        <div class="layout_body">
          ...
          <xsl:if test="//p:page/@id=//p:context/p:home/@page">
            ...
            <script type="text/javascript">hui.on(['Poster'],function() {new Poster();});</script>
          </xsl:if>
            -->
...
<xsl:template match="widget:focus//widget:line">
  <p><xsl:apply-templates/></p>
</xsl:template>

<xsl:template match="widget:focus//widget:strong">
  <strong><xsl:apply-templates/></strong>
</xsl:template>
