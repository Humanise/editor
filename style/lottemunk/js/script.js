...
n.length<2&&(n="0"+n),i+=n}return i},hui.define&&hui.define("hui.Color",hui.Color),!function(e,i,t){function n(e,i){g(e,function(e){return!i(e)})}function o(e,t){var n=i.createElement("script"),o=l
n.onload=n.onerror=n[p]=function(){n[f]&&!/^c|loade/.test(n[f])||o||(n.onload=n[p]=null,o=1,t())},n.async=1,n.src=e,s.insertBefore(n,s.firstChild)}var s=i.getElementsByTagName("head")[0],a={},u={},r={},h={},l=!1,d="push",c="DOMContentLoaded",f="readyState",m="addEventListener",p="onreadystatechange",g=function(e,i){for(var t=0,n=e.length;n>t;++t)if(!i(e[t]))return l
return 1}
!i[f]&&i[m]&&(i[m](c,function w(){i.removeEventListener(c,w,l),i[f]="complete"},l),i[f]="loading")
var v=function(e,i,s){function l(e){return e.call?e():a[e]}function c(){if(!--y){a[p]=1,m&&m()
for(var e in r)g(e.split("|"),l)&&!n(r[e],l)&&(r[e]=[])}}e=e[d]?e:[e]
var f=i&&i.call,m=f?i:s,p=f?e.join(""):i,y=e.length
...
var o=[]
return!n(e,function(e){a[e]||o[d](e)})&&g(e,function(e){return a[e]})?i():!function(e){r[e]=r[e]||[],r[e][d](i),t&&t(o)}(e.join("|")),v}
var y=e.$script
