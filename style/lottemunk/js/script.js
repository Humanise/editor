...
o&&(n.webkitVersion=parseFloat(o[1]))}(hui,navigator.userAgent,window),hui.log=function(e){window.console&&window.console.log&&(1==arguments.length?console.log(e):2==arguments.length?console.log(arguments[0],arguments[1]):console.log(arguments))},hui._demanded=[],hui.define=function(e){for(var i=hui._demanded,t=i.length-1;t>=0;t--){var n=i[t]
hui.array.remove(n.requirements,e),0==n.requirements.length&&(n.callback(),i.splice(t,1))}},hui.demand=function(){for(var e=arguments[0],i=arguments[1],t=[],n=0;n<e.length;n++){var o=hui.evaluate(e[n])
if(!o){t=!1
...
for(n=0,ll=o.length;n!=ll;s.push(o[n++]));return s}var a=e.getElementsByTagName(t||"*"),u=[]
for(n=0;n<a.length;n++)hui.cls.has(a[n],i)&&(u[u.length]=a[n])
return u},hui.get.byTag=function(e,i){for(var t=e.getElementsByTagName(i),n=[],o=0,s=t.length;o!=s;n.push(t[o++]));return n},hui.get.byId=function(e,i){for(var t=e.childNodes,n=t.length-1;n>=0;n--){if(1===t[n].nodeType&&t[n].getAttribute("id")===i)return t[n]
...
t=t.parentNode}return null},hui.get.firstParentByClass=function(e){for(var i=e;i;){if(hui.cls.has(i))return i
i=i.parentNode}return null},hui.get.firstByTag=function(e,i){if(e=hui.get(e)||document.body,e.querySelector&&"*"!==i)return e.querySelector(i)
var t=e.getElementsByTagName(i)
return t[0]},hui.get.firstChild=hui.dom.firstChild,hui.find=function(e,i){return(i||document).querySelector(e)},hui.findAll=function(e,i){var t=(i||document).querySelectorAll(e)
return Array.prototype.slice.call(t)},document.querySelector||(hui.find=function(e,i){return i=i||document.documentElement,"."==e[0]?hui.get.firstByClass(i,e.substr(1)):hui.get.firstByTag(i,e)}),hui.collect=function(e,i){var t={}
for(key in e)t[key]=hui.find(e[key],i)
return t},hui.build=function(e,i,t){t=t||document
var n=""
if(-1!==e.indexOf(".")){var o=e.split(".")
e=o[0]
for(var s=1;s<o.length;s++)s>1&&(n+=" "),n+=o[s]}var a=t.createElement(e)
if(n&&(a.className=n),i)for(var u in i)"text"==u?a.appendChild(t.createTextNode(i.text)):"html"==u?a.innerHTML=i.html:"parent"==u&&hui.isDefined(i.parent)?i.parent.appendChild(a):"parentFirst"==u?0===i.parentFirst.childNodes.length?i.parentFirst.appendChild(a):i.parentFirst.insertBefore(a,i.parentFirst.childNodes[0]):"before"==u?i.before.parentNode.insertBefore(a,i.before):"className"==u?a.className=i.className:"class"==u?a.className=i["class"]:"style"==u&&"object"==typeof i[u]?hui.style.set(a,i[u]):"style"==u&&(hui.browser.msie7||hui.browser.msie6)?a.style.setAttribute("cssText",i[u]):hui.isDefined(i[u])&&a.setAttribute(u,i[u])
return a},hui.position={getTop:function(e){if(e=hui.get(e)){for(var i=e.offsetTop,t=e.offsetParent;null!==t;)i+=t.offsetTop,t=t.offsetParent
...
if(i=s.left+o.clientWidth*(e.target.horizontal||0),t=s.top+o.clientHeight*(e.target.vertical||0),i-=n.clientWidth*(e.source.horizontal||0),t-=n.clientHeight*(e.source.vertical||0),e.top&&(t+=e.top),e.left&&(i+=e.left),e.insideViewPort){var a=hui.window.getViewWidth()
i+n.clientWidth>a&&(i=a-n.clientWidth-(e.viewPartMargin||0)),0>i&&(i=0),0>t&&(t=0)
var u=(hui.window.getViewHeight(),hui.window.getScrollTop()+hui.window.getViewHeight()-n.clientHeight),r=hui.window.getScrollTop()
t=Math.max(Math.min(t,u),r)}n.style.top=Math.round(t)+"px",n.style.left=Math.round(i)+"px"},getRemainingHeight:function(e){for(var i=e.parentNode.clientHeight,t=e.parentNode.childNodes,n=0;n<t.length;n++){var o=t[n]
...
e.$progress&&i.upload.addEventListener("progress",function(i){e.$progress(i.loaded,i.total)},!1),e.$load&&i.upload.addEventListener("load",function(){e.$load()},!1)}else if("POST"==t&&e.files){n=new FormData
...
if(e.headers)for(var a in e.headers)i.setRequestHeader(a,e.headers[a])
...
e.onStart&&e.onStart()
var o,s,a=({x:i.getLeft(),y:i.getTop(),time:Date.now()},!1)
o=function(i){i=hui.event(i),i.stop(i),!a&&e.onBeforeMove&&e.onBeforeMove(i),a=!0,e.onMove(i)}.bind(this),hui.listen(t,n?"touchmove":"mousemove",o),s=function(){hui.unListen(t,n?"touchmove":"mousemove",o),hui.unListen(t,n?"touchend":"mouseup",s),e.onEnd&&e.onEnd(),a&&e.onAfterMove&&e.onAfterMove(),!a&&e.onNotMoved&&e.onNotMoved(),hui.selection.enable(!0)}.bind(this),hui.listen(t,n?"touchend":"mouseup",s),hui.selection.enable(!1)},_nativeListeners:[],_activeDrop:null,listen:function(e){hui.browser.msie||(hui.drag._nativeListeners.push(e),hui.drag._nativeListeners.length>1||(hui.listen(document.body,"dragenter",function(e){for(var i=hui.drag._nativeListeners,t=null,n=0;n<i.length;n++){var o=i[n].element
...
var i=this
this.obs=[]
for(var t=function(){i._imageChanged(this.huiPreloaderIndex,"imageDidLoad")},n=function(){i._imageChanged(this.huiPreloaderIndex,"imageDidGiveError")},o=function(){i._imageChanged(this.huiPreloaderIndex,"imageDidAbort")},s=e;s<this.images.length+e;s++){var a=s
a>=this.images.length&&(a-=this.images.length)
var u=new Image
u.huiPreloaderIndex=a,u.onload=t,u.onerror=n,u.onabort=o,u.src=(this.options.context?this.options.context:"")+this.images[a],this.obs.push(u)}},_imageChanged:function(e,i){this.loaded++,this.delegate[i]&&this.delegate[i](this.loaded,this.images.length,e),this.loaded==this.images.length&&this.delegate.allImagesDidLoad&&this.delegate.allImagesDidLoad()}},hui.cookie={set:function(e,i,t){var n
if(t){var o=new Date
...
var a=!("scrollLeft"==t||"scrollTop"==t||""==t)
if(null!==e)s.from=e
else if("transform"==t)s.transform=hui.animation.Item.parseTransform(i,this.element)
else if(hui.browser.opacity||"opacity"!=t)if(a){var u=hui.style.get(this.element,t),r=hui.animation._parseStyle(u)
s.from=r.value}else s.from=this.element[t]
else s.from=this._getIEOpacity(this.element)
if(a){var h=hui.animation._parseStyle(i)
s.to=h.value,s.unit=h.unit,s.updater=hui.browser.opacity||"opacity"!=t?"transform"==t?hui.browser.msie?function(){}:hui.animation._transformUpater:"color"==h.type?hui.animation._colorUpater:hui.animation._lengthUpater:hui.animation._ieOpacityUpdater}else s.to=i,s.unit=null,s.updater=hui.animation._propertyUpater
...
return i?"MozTransform":"WebkitTransform"}(),hui.animation.Item.parseTransform=function(e,i){var t,n,o={},s=/rotate\(([0-9\.]+)([a-z]+)\)/i,a=e.match(s)
a&&(t=0,i.style[hui.animation.TRANSFORM]&&(n=i.style[hui.animation.TRANSFORM].match(s),n&&(t=parseFloat(n[1]))),o.rotate={from:t,to:parseFloat(a[1]),unit:a[2]})
var u=/scale\(([0-9\.]+)\)/i,r=e.match(u)
return r&&(t=1,i.style[hui.animation.TRANSFORM]&&(n=i.style[hui.animation.TRANSFORM].match(u),n&&(t=parseFloat(n[1]))),o.scale={from:t,to:parseFloat(r[1])}),o},hui.animation.Item.prototype._getIEOpacity=function(e){var i,t=hui.style.get(e,"filter").toLowerCase()
...
if(1==e)return 1
var i=.3,t=i/4
return e-=1,-1*Math.pow(2,10*e)*Math.sin(2*(e-t)*Math.PI/i)},elasticOut:function(e){if(0==e)return 0
if(1==e)return 1
var i=.3,t=i/4
return Math.pow(2,-10*e)*Math.sin(2*(e-t)*Math.PI/i)+1},elasticInOut:function(e){if(0==e)return 0
if(e=2*e,2==e)return 1
var i=.3*1.5,t=i/4
return 1>e?(e-=1,-.5*Math.pow(2,10*e)*Math.sin(2*(e-t)*Math.PI/i)):(e-=1,.5*Math.pow(2,-10*e)*Math.sin(2*(e-t)*Math.PI/i)+1)},bounceIn:function(e){return 1-hui.ease.bounceOut(1-e)},bounceOut:function(e){var i,t=7.5625,n=2.75
...
return{r:parseInt(n[0],16),g:parseInt(n[1],16),b:parseInt(n[2],16)}},hui.Color.hsv2rgb=function(e,i,t){var n,o,s,a=e/360
if(0===i)n=255*t,o=255*t,s=255*t
else{var u,r,h,l=6*a,d=Math.floor(l),c=t*(1-i),f=t*(1-i*(l-d)),m=t*(1-i*(1-(l-d)))
0===d?(u=t,r=m,h=c):1===d?(u=f,r=t,h=c):2==d?(u=c,r=t,h=m):3==d?(u=c,r=f,h=t):4==d?(u=m,r=c,h=t):(u=t,r=c,h=f),n=Math.round(255*u),o=Math.round(255*r),s=Math.round(255*h)}return new Array(n,o,s)},hui.Color.rgb2hsv=function(e,i,t){e/=255,i/=255,t/=255
var n,o,s=Math.min(Math.min(e,i),t),a=Math.max(Math.max(e,i),t),u=a
return a==s?o=0:a==e?o=60*((i-t)/(a-s))%360:a==i?o=60*((t-e)/(a-s))+120:a==t&&(o=60*((e-i)/(a-s))+240),0>o&&(o+=360),n=0===a?0:1-s/a,[Math.round(o),Math.round(100*n),Math.round(100*u)]},hui.Color.rgb2hex=function(e){for(var i="#",t=0;3>t;t++){var n=parseInt(e[t]).toString(16)
n.length<2&&(n="0"+n),i+=n}return i},hui.define&&hui.define("hui.Color",hui.Color),!function(e,i,t){function n(e,i){p(e,function(e){return!i(e)})}function o(e,t){var n=i.createElement("script"),o=l
n.onload=n.onerror=n[g]=function(){n[f]&&!/^c|loade/.test(n[f])||o||(n.onload=n[g]=null,o=1,t())},n.async=1,n.src=e,s.insertBefore(n,s.firstChild)}var s=i.getElementsByTagName("head")[0],a={},u={},r={},h={},l=!1,d="push",c="DOMContentLoaded",f="readyState",m="addEventListener",g="onreadystatechange",p=function(e,i){for(var t=0,n=e.length;n>t;++t)if(!i(e[t]))return l
return 1}
!i[f]&&i[m]&&(i[m](c,function w(){i.removeEventListener(c,w,l),i[f]="complete"},l),i[f]="loading")
var v=function(e,i,s){function l(e){return e.call?e():a[e]}function c(){if(!--y){a[g]=1,m&&m()
for(var e in r)p(e.split("|"),l)&&!n(r[e],l)&&(r[e]=[])}}e=e[d]?e:[e]
var f=i&&i.call,m=f?i:s,g=f?e.join(""):i,y=e.length
return t(function(){n(e,function(e){return h[e]?(g&&(u[g]=1),void c()):(h[e]=1,g&&(u[g]=1),void o(v.path?v.path+e+".js":e,c))})},0),v}
v.get=o,v.ready=function(e,i,t){e=e[d]?e:[e]
var o=[]
return!n(e,function(e){a[e]||o[d](e)})&&p(e,function(e){return a[e]})?i():!function(e){r[e]=r[e]||[],r[e][d](i),t&&t(o)}(e.join("|")),v}
var y=e.$script
...
for(var a=0;a<n.length;a++)for(var u=0;u<o.length;u++)o[u].element==n[a]&&i.push(o[u])}return i},hui.ui.getDescendants=function(e){var i=[]
if(e){var t=e.getElement?e.getElement():e
if(t){var n=t.getElementsByTagName("*"),o=[]
for(var s in hui.ui.objects)o.push(hui.ui.objects[s])
for(var a=0;a<n.length;a++)for(var u=0;u<o.length;u++)n[a]==o[u].element&&i.push(o[u])}}return i},hui.ui.getAncestor=function(e,i){for(var t=hui.ui.getAncestors(e),n=0;n<t.length;n++)if(hui.cls.has(t[n].getElement(),i))return t[n]
...
var o
if(e.delegates)for(var s=0;s<e.delegates.length;s++){var a,u=e.delegates[s],r="$"+i+"$"+e.name
e.name&&u[r]?a=u[r](t,n):u["$"+i]&&(a=u["$"+i](t,n)),void 0===o&&void 0!==a&&"undefined"!=typeof a&&(o=a)}var h=hui.ui.callSuperDelegates(e,i,t,n)
...
for(var o,s=0;s<hui.ui.delegates.length;s++){var a,u=hui.ui.delegates[s]
e.name&&u["$"+i+"$"+e.name]?a=u["$"+i+"$"+e.name](t,n):u["$"+i]&&(a=u["$"+i](t,n)),void 0===o&&void 0!==a&&"undefined"!=typeof a&&(o=a)}return o},hui.ui.resolveImageUrl=function(e,i,t,n){for(var o=0;o<e.delegates.length;o++)if(e.delegates[o].$resolveImageUrl)return e.delegates[o].$resolveImageUrl(i,t,n)
for(var s=0;s<hui.ui.delegates.length;s++){var a=hui.ui.delegates[s]
if(a.$resolveImageUrl)return a.$resolveImageUrl(i,t,n)}return null},hui.ui.include=function(e){hui.ui.request({url:e.url,$text:function(i){var t=hui.build("div",{html:i,parent:document.body})
...
var t=e.$success,n=e.$object,o=e.$text,s=e.$xml,a=e.$failure,u=e.$forbidden,r=e.message
...
var i,a
"string"==typeof t?hui.request.isXMLResponse(e)?hui.ui.callDelegates(e,"success$"+t):(i=e.responseText.replace(/^\s+|\s+$/g,""),a=i.length>0?hui.string.fromJSON(e.responseText):"",hui.ui.callDelegates(a,"success$"+t)):s&&hui.request.isXMLResponse(e)?s(e.responseXML):n?(i=e.responseText.replace(/^\s+|\s+$/g,""),a=i.length>0?hui.string.fromJSON(e.responseText):null,n(a)):"function"==typeof t?t(e):o&&o(e.responseText)},e.$failure=function(i){"string"==typeof a?hui.ui.callDelegates(i,"failure$"+a):"function"==typeof a?a(i):(e.message&&e.message.start&&hui.ui.hideMessage(),hui.ui.handleRequestError())},e.$exception=e.$exception||function(e,i){throw hui.log(e),hui.log(i),e},e.$forbidden=function(i){e.message&&e.message.start&&hui.ui.hideMessage(),u?u(i):(e.$failure(i),hui.ui.handleForbidden())},e.message&&e.message.start&&hui.ui.msg({text:e.message.start,busy:!0,delay:e.message.delay}),hui.request(e)},hui.ui.parseItems=function(e){var i=e.documentElement,t=[]
...
for(var n=0,o=0,s=0;s<this.images.length;s++){var a=this._getLargestSize({width:i,height:t},this.images[s])
n=Math.max(n,a.width),o=Math.max(o,a.height)}t=Math.floor(Math.min(t,o)),i=Math.floor(Math.min(i,n)),(i!=this.width||t!=this.height)&&(this.width=i,this.height=t,this.dirty=!0)},_updateUI:function(){if(this.dirty){this.nodes.innerViewer.innerHTML=""
...
if(e){var a,u
if(n)a=200*i,u=hui.ease.fastSlow,u=hui.ease.quadOut
else if(i>1)a=Math.min(i*this.options.transitionReturn,2e3),u=this.options.easeReturn
else{var r=0==this.index||this.index==this.images.length-1
u=r?this.options.easeEnd:this.options.ease,t||(u=this.options.easeAuto),a=r?this.options.transitionEnd:this.options.transition}hui.animate({node:this.nodes.innerViewer,css:{marginLeft:s+"px"},duration:a,ease:u,$render:function(e,i){this.position=o+(s-o)*i,this._draw()}.bind(this)})}else this._draw()
...
var i=e.variant||"standard",t=e.closable?'<a class="hui_box_close hui_box_close_'+i+'" href="#"></a>':""
return e.title&&(t+='<div class="hui_box_header"><strong class="hui_box_title">'+hui.string.escape(hui.ui.getTranslated(e.title))+"</strong></div>"),t+='<div class="hui_box_body" style="'+(e.padding?"padding: "+e.padding+"px;":"")+(e.width?"width: "+e.width+"px;":"")+'"></div>',e.element=hui.build("div",{"class":"hui_box hui_box_"+i,html:t,style:e.width?e.width+"px":null}),e.absolute&&hui.cls.add(e.element,"hui_box_absolute"),new hui.ui.Box(e)},hui.ui.Box.prototype={nodes:{body:".hui_box_body",close:".hui_box_close"},_close:function(e){hui.stop(e),this.hide(),this.fire("boxWasClosed"),this.fire("close")},shake:function(){hui.effect.shake({element:this.element})},addToDocument:function(){document.body.appendChild(this.element)},add:function(e){var i=this.nodes.body
i.appendChild(e.getElement?e.getElement():e)},show:function(){var e=this.element
...
this.adaptive&&(e+=" hui_searchfield-adaptive"),this.focused&&(e+=" hui_searchfield-focus"),""!=this.value&&(e+=" hui_searchfield-dirty"),this.element.className=e},_fieldChanged:function(){this.field.value!=this.value&&(this.value=this.field.value,this._updateClass(),this.fireValueChange())}},window.define&&define("hui.ui.SearchField",hui.ui.SearchField),hui.ui.Overlay=function(e){this.options=e,this.element=hui.get(e.element),this.name=e.name,this.icons={},this.visible=!1,hui.ui.extend(this),this._addBehavior()},hui.ui.Overlay.create=function(e){e=e||{}
var i="hui_overlay"+(e.variant?" hui_overlay_"+e.variant:"")
e.variant||(i+=" hui_context_dark")
var t=e.element=hui.build("div",{className:i,style:"display:none"})
return document.body.appendChild(t),new hui.ui.Overlay(e)},hui.ui.Overlay.prototype={_addBehavior:function(){},addIcon:function(e,i){var t=this,n=hui.build("div",{className:"hui_overlay_icon"})
n.style.backgroundImage="url("+hui.ui.getIconUrl(i,32)+")",hui.listen(n,"click",function(i){t._iconWasClicked(e,i)}),this.icons[e]=n,this.element.appendChild(n)},addText:function(e){this.element.appendChild(hui.build("span",{"class":"hui_overlay_text",text:e}))},add:function(e){this.element.appendChild(e.getElement())},hideIcons:function(e){for(var i=0;i<e.length;i++)this.icons[e[i]].style.display="none"},showIcons:function(e){for(var i=0;i<e.length;i++)this.icons[e[i]].style.display=""},_iconWasClicked:function(e,i){hui.ui.callDelegates(this,"iconWasClicked",e,i)},showAtElement:function(e,i){if(i=i||{},hui.ui.positionAtElement(this.element,e,i),i.autoHide&&this._autoHide(e),!this.visible){hui.browser.msie?this.element.style.display="block":(hui.style.set(this.element,{display:"block",opacity:0}),hui.animate(this.element,"opacity",1,150))
...
this.element.style.zIndex=i+1,hui.ui.showCurtain({widget:this,zIndex:i,color:"auto"})}},$curtainWasClicked:function(){this.hide()},hide:function(){hui.ui.hideCurtain(this),this.element.style.display="none",this.visible=!1},clear:function(){hui.ui.destroyDescendants(this.element),this.element.innerHTML=""}},hui.ui.Button=function(e){this.options=e,this.name=e.name,this.element=hui.get(e.element),this.enabled=!hui.cls.has(this.element,"hui_button_disabled"),hui.ui.extend(this),this._attach(),e.listener&&this.listen(e.listener),e.listen&&this.listen(e.listen)},hui.ui.Button.create=function(e){e=hui.override({text:"",highlighted:!1,enabled:!0},e)
var i="hui_button"+(e.highlighted?" hui_is_highlighted":"")
e.variant&&(i+=" hui_button_"+e.variant),e.small&&e.variant&&(i+=" hui_button_small_"+e.variant),e.small&&(i+=" hui_button_small"),e.enabled||(i+=" hui_is_disabled")
var t=e.text?hui.ui.getTranslated(e.text):null
e.title&&(t=hui.ui.getTranslated(e.title))
var n=e.element=hui.build("a",{"class":i,href:"javascript://"})
if(e.icon){var o=hui.build("span",{parent:n,"class":"hui_button_icon",style:"background-image:url("+hui.ui.getIconUrl(e.icon,16)+")"})
t||hui.cls.add(o,"hui_button_icon_notext")}return t&&hui.dom.addText(n,t),new hui.ui.Button(e)},hui.ui.Button.prototype={_attach:function(){var e=this
...
if(!a.test(o.value))return hui.ui.showMessage({text:s.message,duration:2e3}),void o.focus()}i.push({label:n.label,value:o.value})}var u=op.page.path+"services/parts/formula/",r={id:this.id,fields:i}
hui.ui.showMessage({text:"Sender besked...",busy:!0}),hui.ui.request({url:u,json:{data:r},$success:this._success.bind(this),$failure:this._failure.bind(this)})},_success:function(){hui.ui.showMessage({text:"Beskeden er nu sendt",icon:"common/success",duration:2e3}),this.element.reset()},_failure:function(){hui.ui.showMessage({text:"Beskeden kunne desværre ikke afleveres",duration:5e3})}},window.define&&define("op.part.Formula"),op.part.Image=function(e){var i=this.element=hui.get(e.element),t=(i.src,i.parentNode)
...
window.opMapReady=null,this.loaded=!0}.bind(this),hui.require("https://maps.googleapis.com/maps/api/js?callback=opMapReady&key=AIzaSyBToLasfCj-kpsD-mGsimi1P32emIJeG-U"))},op.part.Map.types={roadmap:"ROADMAP",terrain:"TERRAIN"},op.part.Map.prototype={initialize:function(){hui.log("init"),op.part.Map.onReady(this.ready.bind(this))},ready:function(){{var e={zoom:this.options.zoom,center:new google.maps.LatLng(-34.397,150.644),mapTypeId:google.maps.MapTypeId[this.options.type.toUpperCase()],scrollwheel:!1}
...
if(i){e.innerHTML=hui.dom.getText(i)
var t=hui.get.firstByTag(e,"iframe")
t&&(t.setAttribute("allowfullscreen","allowfullscreen"),t.setAttribute("mozallowfullscreen","mozallowfullscreen"),t.setAttribute("webkitallowfullscreen","webkitallowfullscreen"))}e.style.background=""},_vimeo:function(e,i){var t="callback_"+e,n="http://vimeo.com/api/v2/video/"+e+".json?callback="+t
...
var t=i.findByTag("a")
if(t){var n=e[t.getAttribute("data-path")]
if(!n)return
for(var o=hui.get.byTag(document.body,"a"),s=0;s<o.length;s++)if(n==o[s].getAttribute("name"))return i.stop(),void hui.window.scrollTo({element:o[s].parentNode,duration:1e3,top:"theater"==n?40:140})}}),hui.listen("handmade","click",function(e){hui.stop(e)
...
var t="http://www.youtube.com/embed/"+this.key,n='<iframe class="movies_iframe" width="640" height="480" src="'+t+'?autoplay=1" frameborder="0" allowfullscreen="allowfullscreen"></iframe>'
e.build("div",{"class":"movies_player",html:n,parent:this.element}),i.active=this},_moveTop:function(){var i=this.element.parentNode,t=i.parentNode,n=e.find(".movies_item",t)
n!=i&&(t.removeChild(n),t.insertBefore(n,i),t.removeChild(i),n=e.find(".movies_item",t),t.insertBefore(i,n))},disable:function(){var i=e.find(".movies_player",this.element)
e.dom.remove(i)}}
for(var t=e.get.byClass(document.body,"js-movie-poster"),n=0;n<t.length;n++)new i({element:t[n]})}),require(["hui"],function(e){var i=function(e){return(2*e-1)*(2*e-1)*-1+1}
e.onReady(function(){var t=e.get.byClass(document.body,"js-photo")
e.each(t,function(t){var n=e.find(".js-photo-effect",t),o=e.position.get(t),s={width:t.clientWidth,height:t.clientHeight}
e.ui.listen({$$afterResize:function(){o=e.position.get(t),s={width:t.clientWidth,height:t.clientHeight}}}),e.listen(t,"click",function(i){e.stop(i),e.ui.get("photoGallery").showById(t.getAttribute("data-id"))}),e.listen(window,"mousemove",function(t){t=e.event(t)
var a=(t.getLeft()-o.left)/s.width,u=(t.getTop()-o.top)/s.height
n.style.marginLeft=20*a+"px",n.style.marginTop=20*u+"px"
var r=e.between(0,i(a),1)*e.between(0,i(u),1)
n.style.opacity=r})})})}),require(["hui"],function(e){var i=e.find(".theater"),t=e.find(".theater_photo",i),n=e.find(".theater_stages",i)
if(i){var o=e.window.getViewWidth(),s=!1
e.browser.animation||(e.style.setOpacity(t,0),e.style.setOpacity(n,0)),e.parallax.listen({element:i,$scroll:function(a){var u=a>.2&&.8>a&&o>700
s!=u&&(e.cls.set(document.body,"is-full",u),e.browser.animation?e.cls.set(document.body,"is-dark",u):e.animate({node:document.body,css:{"background-color":u?"#000":"#fff"},duration:1e3}),s=u)
var r=a>.3&&.7>a
this.shown!=r&&(r&&e.animate({node:t,css:{opacity:r?1:0},ease:e.ease.flicker,duration:3e3,$complete:function(){e.browser.animation?e.cls.set(i,"is-final",a>0&&1>a):e.animate({node:n,css:{opacity:r?1:0},ease:e.ease.slowFast,duration:5e3})}}),this.shown=r)}}),e.parallax.listen({$resize:function(t,n){i.style.height=t>700?Math.round(.8*n)+"px":"",e.browser.mediaQueries||e.cls.set(document.body,"small",1200>t),o=t}})}})
