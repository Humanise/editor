...
else{var u,r,h,l=6*a,d=Math.floor(l),c=t*(1-i),f=t*(1-i*(l-d)),g=t*(1-i*(1-(l-d)))
0===d?(u=t,r=g,h=c):1===d?(u=f,r=t,h=c):2==d?(u=c,r=t,h=g):3==d?(u=c,r=f,h=t):4==d?(u=g,r=c,h=t):(u=t,r=c,h=f),n=Math.round(255*u),o=Math.round(255*r),s=Math.round(255*h)}return new Array(n,o,s)},hui.Color.rgb2hsv=function(e,i,t){e/=255,i/=255,t/=255
...
n.onload=n.onerror=n[p]=function(){n[f]&&!/^c|loade/.test(n[f])||o||(n.onload=n[p]=null,o=1,t())},n.async=1,n.src=e,s.insertBefore(n,s.firstChild)}var s=i.getElementsByTagName("head")[0],a={},u={},r={},h={},l=!1,d="push",c="DOMContentLoaded",f="readyState",g="addEventListener",p="onreadystatechange",m=function(e,i){for(var t=0,n=e.length;n>t;++t)if(!i(e[t]))return l
return 1}
!i[f]&&i[g]&&(i[g](c,function w(){i.removeEventListener(c,w,l),i[f]="complete"},l),i[f]="loading")
var v=function(e,i,s){function l(e){return e.call?e():a[e]}function c(){if(!--y){a[p]=1,g&&g()
for(var e in r)m(e.split("|"),l)&&!n(r[e],l)&&(r[e]=[])}}e=e[d]?e:[e]
var f=i&&i.call,g=f?i:s,p=f?e.join(""):i,y=e.length
return t(function(){n(e,function(e){return h[e]?(p&&(u[p]=1),void c()):(h[e]=1,p&&(u[p]=1),void o(v.path?v.path+e+".js":e,c))})},0),v}
v.get=o,v.ready=function(e,i,t){e=e[d]?e:[e]
var o=[]
return!n(e,function(e){a[e]||o[d](e)})&&m(e,function(e){return a[e]})?i():!function(e){r[e]=r[e]||[],r[e][d](i),t&&t(o)}(e.join("|")),v}
var y=e.$script
...
e.setDelegate({allImagesDidLoad:function(){this.progress.style.display="none",this.start()}.bind(this),imageDidLoad:function(e,i){this.progress.innerHTML=Math.round(e/i*100)+"%"}.bind(this)}),e.addImages(this.leftImages),e.addImages(this.rightImages),e.load()},window.define&&define("Poster")
