...
else{var a,r,h,l=6*u,d=Math.floor(l),c=t*(1-i),f=t*(1-i*(l-d)),g=t*(1-i*(1-(l-d)))
0===d?(a=t,r=g,h=c):1===d?(a=f,r=t,h=c):2==d?(a=c,r=t,h=g):3==d?(a=c,r=f,h=t):4==d?(a=g,r=c,h=t):(a=t,r=c,h=f),n=Math.round(255*a),o=Math.round(255*r),s=Math.round(255*h)}return new Array(n,o,s)},hui.Color.rgb2hsv=function(e,i,t){e/=255,i/=255,t/=255
...
n.onload=n.onerror=n[m]=function(){n[f]&&!/^c|loade/.test(n[f])||o||(n.onload=n[m]=null,o=1,t())},n.async=1,n.src=e,s.insertBefore(n,s.firstChild)}var s=i.getElementsByTagName("head")[0],u={},a={},r={},h={},l=!1,d="push",c="DOMContentLoaded",f="readyState",g="addEventListener",m="onreadystatechange",p=function(e,i){for(var t=0,n=e.length;n>t;++t)if(!i(e[t]))return l
return 1}
!i[f]&&i[g]&&(i[g](c,function w(){i.removeEventListener(c,w,l),i[f]="complete"},l),i[f]="loading")
var v=function(e,i,s){function l(e){return e.call?e():u[e]}function c(){if(!--y){u[m]=1,g&&g()
for(var e in r)p(e.split("|"),l)&&!n(r[e],l)&&(r[e]=[])}}e=e[d]?e:[e]
var f=i&&i.call,g=f?i:s,m=f?e.join(""):i,y=e.length
return t(function(){n(e,function(e){return h[e]?(m&&(a[m]=1),void c()):(h[e]=1,m&&(a[m]=1),void o(v.path?v.path+e+".js":e,c))})},0),v}
v.get=o,v.ready=function(e,i,t){e=e[d]?e:[e]
var o=[]
return!n(e,function(e){u[e]||o[d](e)})&&p(e,function(e){return u[e]})?i():!function(e){r[e]=r[e]||[],r[e][d](i),t&&t(o)}(e.join("|")),v}
var y=e.$script
...
e.prototype={nodes:{icon:".layout_search_icon",text:".layout_search_text"},_attach:function(){hui.on(this.nodes.icon,"tap",this._toggle.bind(this)),hui.listen(this.nodes.text,"focus",this._focus.bind(this)),hui.listen(this.nodes.text,"blur",this._blur.bind(this)),this.nodes.icon.setAttribute("focusable","false")},_toggle:function(){hui.cls.toggle(this.element,"layout_search_active")
